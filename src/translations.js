const FR = {
  ...
  artistTypes: {
    ...
    types: [
      ...
      { icon: "💃", title: "Danseurs", desc: "Danseurs, chorégraphes et performeurs : partage ton art et monétise tes performances." },
...
const EN = {
  ...
  artistTypes: {
    ...
    types: [
      ...
      { icon: "💃", title: "Dancers", desc: "Dancers, choreographers and performers: share your art and monetize your performances." },
